...
const env = {
  ...
  dailyAiRequestLimit: asDailyAiRequestLimit(process.env.DAILY_AI_REQUEST_LIMIT, 10),
  dailyAiImageLimit: asDailyAiRequestLimit(process.env.DAILY_AI_IMAGE_LIMIT, 1),
